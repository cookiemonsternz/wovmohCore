...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_wovmohCore)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_wovmohCore))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_wovmohCore)() {
    return 1;
}
